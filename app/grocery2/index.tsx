    ...
    <>
      ...
      <SafeAreaView style={styles.container} edges={['right', 'left', 'bottom']}>
        ...
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => {
                  if (category.id === 'fruits') {
                    router.push('/grocery2/fruits' as any);
                  } else if (category.id === 'vegetables') {
                    router.push('/grocery2/fresh-produce' as any);
                  } else {
                    // Default handling for other categories
                    router.push('/grocery2/fresh-fruits' as any);
                  }
                }}
              >
          ...
          >
            {[1, 2, 3, 4].map((item) => (
              <TouchableOpacity key={item} style={styles.popularCard} onPress={() => router.push('/grocery2/fresh-fruits' as any)}>
          ...
          <TouchableOpacity 
            style={styles.banner}
            onPress={() => router.push('/grocery2/fresh-fruits' as any)}
          >
